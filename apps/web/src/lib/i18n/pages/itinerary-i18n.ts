...
export const ITINERARY_PAGE_TRANSLATIONS: Record<LanguageCode, ItineraryTranslations> = {
  ...
  AZ: {
    ...
    destinations: {
      ...
      caucasus_combo: {
        name: "Trans-Qafqaz (Azərbaycan + Gürcüstan + Türkiyə)",
        tag: "1 Səfərdə 3 Ölkə",
        desc: "İpək Yolu xətti: Bakı → Şəki → Tbilisi → Kazbegi → İstanbul.",
      },
    },
  },
  RU: {
    ...
    destinations: {
      ...
      caucasus_combo: {
        name: "Транс-Кавказ (Азербайджан + Грузия + Турция)",
        tag: "3 Страны в 1 Туре",
        desc: "Бесшовный маршрут Шёлкового пути: Баку → Шеки → Тбилиси → Казбеги → Стамбул.",
      },
    },
  },
  FR: {
    ...
    destinations: {
      ...
      caucasus_combo: {
        name: "Trans-Caucase (Azerbaïdjan + Géorgie + Turquie)",
        tag: "3 Pays en 1 Voyage",
        desc: "Parcours Route de la Soie : Bakou → Shaki → Tbilissi → Kazbegi → Istanbul.",
      },
    },
  },
  AR: {
    ...
    destinations: {
      ...
      caucasus_combo: {
        name: "جولة القوقاز الكبرى (أذربيجان + جورجيا + تركيا)",
        tag: "3 دول في رحلة واحدة",
        desc: "رحلة طريق الحرير الأسطورية: باكو ← شاكي ← تبليسي ← كازبيجي ← إسطنبول.",
      },
    },
  },
  DE: {
    ...
    destinations: {
      ...
      caucasus_combo: {
        name: "Transkaukasien (Aserbaidschan + Georgien + Türkei)",
        tag: "3 Länder in 1 Tour",
        desc: "Nahtlose Seidenstraßen-Route: Baku → Scheki → Tiflis → Kazbegi → Istanbul.",
      },
    },
  },
};
