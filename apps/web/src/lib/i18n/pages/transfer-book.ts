...
export const TRANSFER_BOOK_TRANSLATIONS: Record<string, TransferBookTranslations> = {
  EN: {
    ...
    driverGuidePrefTitle: "Driver & Guide Preferences",
    femaleDriverLabel: "Female Chauffeur Preference",
    femaleDriverDesc: "Certified professional female chauffeur for privacy and comfort. Fulfilled on a priority basis subject to shift schedule and availability.",
    femaleDriverTag: "Priority Request (Subject to Availability)",
    additionalGuideLabel: "Driver + Licensed Tour Guide",
    additionalGuideDesc: "Certified bilingual guide accompanies your transfer for cultural insights. Arranged on request subject to guide schedule confirmation.",
    subjectToAvailabilityBadge: "Subject to Availability",
    subjectToAvailabilityNote: "Please note: Female chauffeur and licensed tour guide preferences are priority requests fulfilled subject to operational schedule and availability upon flight arrival.",
  },
  AZ: {
    ...
    driverGuidePrefTitle: "Sürücü və Bələdçi Seçimləri",
    femaleDriverLabel: "Xanım Sürücü Seçimi",
    femaleDriverDesc: "Məxfilik və rahatlıq təmin edən sertifikatlı peşəkar xanım sürücü. Növbə cədvəli və mövcudluqdan asılı olaraq prioritet qaydada təyin edilir.",
    femaleDriverTag: "Prioritetli Sorğu (Mövcudluqdan Asılı)",
    additionalGuideLabel: "Sürücü + Lisenziyalı Bələdçi",
    additionalGuideDesc: "Səfəriniz boyu mədəni və tarixi məlumatlar verən lisenziyalı bələdçi. Bələdçi qrafiki və təsdiqindən asılı olaraq təşkil olunur.",
    subjectToAvailabilityBadge: "Mövcudluqdan Asılı",
    subjectToAvailabilityNote: "Qeyd: Xanım sürücü və lisenziyalı bələdçi seçimi prioritet sorğu olaraq qəbul edilir və uçuşun təsdiqlənməsi anında cədvəl üzrə mövcudluqdan asılı olaraq təmin edilir.",
  },
  RU: {
    ...
    driverGuidePrefTitle: "Пожелания к Водителю и Гиду",
    femaleDriverLabel: "Женщина-водитель",
    femaleDriverDesc: "Профессиональный лицензированный водитель-женщина для спокойствия и комфорта. Предоставляется в приоритетном порядке при наличии свободных смен.",
    femaleDriverTag: "Приоритетный запрос (при наличии)",
    additionalGuideLabel: "Водитель + Лицензированный Гид",
    additionalGuideDesc: "Лицензированный гид сопровождает поездку для увлекательного знакомства со страной. Предоставляется по запросу при наличии гида в графике.",
    subjectToAvailabilityBadge: "При наличии",
    subjectToAvailabilityNote: "Обратите внимание: назначение женщины-водителя и экскурсовода является приоритетным пожеланием и зависит от доступности специалистов на момент прибытия рейса.",
  },
  FR: {
    ...
    driverGuidePrefTitle: "Préférences Chauffeur & Guide",
    femaleDriverLabel: "Chauffeuse (Femme)",
    femaleDriverDesc: "Chauffeuse professionnelle certifiée pour votre confort et discrétion. Traitée en priorité sous réserve des plannings de service.",
    femaleDriverTag: "Demande Prioritaire (Selon Disponibilité)",
    additionalGuideLabel: "Chauffeur + Guide Touristique Agréé",
    additionalGuideDesc: "Guide officiel certifié accompagnant votre transfert pour une introduction culturelle. Organisé sur demande selon les disponibilités de planning.",
    subjectToAvailabilityBadge: "Sous réserve de disponibilité",
    subjectToAvailabilityNote: "Veuillez noter : les demandes de chauffeuse et de guide accompagnateur sont traitées en priorité mais restent soumises à la disponibilité des plannings au moment du vol.",
  },
  AR: {
    ...
    driverGuidePrefTitle: "تفضيلات السائق والمرشد",
    femaleDriverLabel: "سائقة أنثى (طلب خاص)",
    femaleDriverDesc: "سائقة محترفة معتمدة لتوفير أقصى درجات الخصوصية والراحة. يتم الترتيب بأولوية قصوى وفقاً لجدول العمل والتوافر.",
    femaleDriverTag: "طلب ذو أولوية (حسب التوفر)",
    additionalGuideLabel: "سائق + مرشد سياحي مرخص",
    additionalGuideDesc: "مرشد سياحي مرخص يرافقكم لتقديم معلومات ثقافية وتاريخية مميزة. يتم الترتيب حسب توفر جداول المرشدين.",
    subjectToAvailabilityBadge: "حسب التوفر",
    subjectToAvailabilityNote: "تنبيه هام: اختيار سائقة أنثى أو مرشد سياحي مرافق يخضع لجدول التوافر التشغيلي في موعد وصول الرحلة، مع منحه أولوية قصوى من فريق العمليات.",
  },
  DE: {
    ...
    driverGuidePrefTitle: "Fahrer- & Reiseleiter-Optionen",
    femaleDriverLabel: "Chauffeurin (Frau)",
    femaleDriverDesc: "Zertifizierte professionelle Chauffeurin für Komfort und Diskretion. Wird mit höchster Priorität je nach Schichtplan und Verfügbarkeit zugewiesen.",
    femaleDriverTag: "Prioritätsanfrage (nach Verfügbarkeit)",
    additionalGuideLabel: "Fahrer + Lizenzierter Reiseleiter",
    additionalGuideDesc: "Ein lizenzierter Reiseleiter begleitet Ihre Fahrt und gibt exklusive Einblicke in Land und Kultur. Nach Verfügbarkeit organisiert.",
    subjectToAvailabilityBadge: "Nach Verfügbarkeit",
    subjectToAvailabilityNote: "Bitte beachten Sie: Der Wunsch nach einer Chauffeurin oder einem begleitenden Reiseleiter wird prioritär bearbeitet, hängt jedoch von der Verfügbarkeit im Dienstplan zum Ankunftszeitpunkt ab.",
  },
};
