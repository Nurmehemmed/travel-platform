...
export function HeroSection({ slides = DEFAULT_SLIDES }: HeroSectionProps) {
  ...
  return (
    <div className="relative min-h-[92vh] w-full bg-slate-950 font-sans text-white overflow-x-hidden">
      ...
      {/* ══════════════════════════════════════════════════════
          4. CONSOLIDATED FLOATING DOCK (Bottom-Right)
          Unified glassmorphism capsule grouping e-Visa, Transfer, and WhatsApp
      ══════════════════════════════════════════════════════ */}
      <aside
        aria-label="Quick Travel Services Dock"
        className="fixed bottom-5 right-4 sm:right-6 z-50 transition-all duration-300 print:hidden"
      >
        <div className="flex items-center rounded-2xl border border-white/15 bg-slate-950/85 p-1.5 shadow-2xl backdrop-blur-xl transition-all hover:border-white/25">
          {/* Segment 1: ASAN e-Visa */}
          <Link
            href="/visa"
            prefetch={true}
            className="group flex items-center gap-2.5 rounded-xl px-3 py-2 text-left transition-colors hover:bg-white/10"
            title="Official ASAN e-Visa Online Application"
          >
            <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-white/10 text-slate-200 border border-white/10 group-hover:border-white/20">
            ...
            <div className="hidden sm:flex flex-col leading-none">
              ...
              <span className="text-xs font-bold text-white mt-0.5">e-Visa</span>
            </div>
          </Link>
          ...
          {/* Segment 2: Airport Transfer */}
          <Link
            href="/transfer"
            prefetch={true}
            className="group flex items-center gap-2.5 rounded-xl px-3 py-2 text-left transition-colors hover:bg-white/10"
            title="Book Baku Airport (GYD) Transfer"
          >
            <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-white/10 text-slate-200 border border-white/10 group-hover:border-white/20">
            ...
            <div className="hidden sm:flex flex-col leading-none">
              ...
              <span className="text-xs font-bold text-white mt-0.5">Transfer</span>
            </div>
          </Link>
          ...
          <a
            ...
            aria-label="Direct Chat with Tour Specialist on WhatsApp"
            title="Chat on WhatsApp"
          >
            <div className="relative flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-emerald-600/90 text-white shadow-sm transition-transform group-hover:scale-105">
            ...
            <span className="hidden md:inline text-xs font-bold text-emerald-400">
              Support
            </span>
          </a>
        </div>
