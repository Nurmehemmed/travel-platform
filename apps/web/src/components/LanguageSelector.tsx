...
export function LanguageSelector({
  ...
  return (
    <div ref={containerRef} className={`relative shrink-0 ${className}`}>
      ...
      {isOpen && (
        <div
          className="absolute right-0 top-full mt-2 w-48 max-w-[calc(100vw-2rem)] rounded-2xl p-1.5 shadow-2xl z-50 animate-scale-up border bg-[#f0f9ff] border-sky-100"
          style={{
